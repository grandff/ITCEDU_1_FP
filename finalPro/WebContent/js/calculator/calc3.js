...
function init(){
    document.getElementById("but2").style.backgroundColor = '#64ABD1';
    document.getElementById("but3").style.backgroundColor = '#64ABD1';
    document.getElementById("but5").style.backgroundColor = '#64ABD1';
...
function but(num){
    switch(num){
        case 1:     // 농지 선택
            document.getElementById("but1").style.backgroundColor = '#64ABD1';
        ...
        case 4: 
            ...
            document.getElementById("but4").style.backgroundColor = '#64ABD1';
            document.getElementById("but5").style.display = 'none';
            document.getElementById("but6").style.display = 'none';
        ...
        case 6: 
            ...
            document.getElementById("but6").style.backgroundColor = '#64ABD1';
