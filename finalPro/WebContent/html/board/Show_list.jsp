    	...
    	<form action="/finalPro/boardController.do" method="post">
    		<div id = "titlelist">
	    		...
	    		<%
	    			...
	    			response.sendRedirect(vUrl + "/boardController.do?q=boardTitle&list=3");
	    		}
	    		%>
	    		<div id = "titlefooter">
	    			<input type = "button" value = "글쓰기" class = "btn" onclick = "javascript:location.href = '<%=vUrl %>/memberController.do?q=300&list=3'">
                	<ul class="writenavi">
                   	 <li><a href="#">◁</a></li>
                    <li><a href="#">1</a></li>
                    <li><a href="#">2</a></li>
